...
from pgvector.sqlalchemy import Vector  # pgvector 확장 사용
...
#PostgreSQL 연결 설정
DATABASE_URL = os.getenv("DATABASE_URL")  # 예: postgresql+psycopg2://user:password@host:port/dbname
...
if __name__ == "__main__":
    INPUT = "path/to/naverfinance_mainnews_2025-02-06.jsonl"
